...
public class QuizQuestionCriticalThinking
{
    int id;
    String question;
    String answer;
    ...
    public QuizQuestionCriticalThinking() { }

    public QuizQuestionCriticalThinking(int id, String question, String answer, String wronganswerone, String wronganswertwo, String wronganswerthree, String wronganswerfour)
    {
        this.id = id;
