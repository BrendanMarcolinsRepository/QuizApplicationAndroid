...
public class DatabaseCriticalThinking extends SQLiteOpenHelper
{

    public static final String DATABASE_NAME = "CriticalThingQuestionDatabase";
    public static final String USERS_TABLE_NAME = "criticalThingQuestionTable";
    ...
    public DatabaseCriticalThinking(Context context)
    {
    ...
    public String getUsersTableName()
    {
        ...
        Cursor c= database.rawQuery("SELECT name FROM sqlite_master WHERE type = 'criticalThingQuestionTable'",null);
        c.moveToFirst();
    ...
    public void addQuestion(QuizQuestionCriticalThinking question)
    {
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public QuizQuestionCriticalThinking getQuestion(int id)
    {
        QuizQuestionCriticalThinking question;
        SQLiteDatabase database = this.getWritableDatabase();
        ...
        if (cursor != null)
            cursor.moveToFirst();
        question = new QuizQuestionCriticalThinking(Integer.parseInt(cursor.getString(0)),cursor.getString(1),
