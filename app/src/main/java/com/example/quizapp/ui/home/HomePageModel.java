...
import com.example.quizapp.DatabaseLoader;
import com.example.quizapp.R;
import com.example.quizapp.UserDatabase;
...
public class HomePageModel extends Fragment
{
    ...
    private com.example.quizapp.HomePage h1;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState)
    {

        com.example.quizapp.HomePage homePage = (com.example.quizapp.HomePage) getActivity();

        h1 =  (com.example.quizapp.HomePage) getActivity();
        this.homePage =
